...
type ControlWrapper struct {
	...
	CreatedBy uint           `json:"created_by" gorm:"column:created_by;comment:创建人"`
	UpdatedAt time.Time      `json:"updated_at" gorm:"column:updated_at;autoUpdateTime;comment:更新时间"`
	UpdatedBy uint           `json:"updated_by" gorm:"column:updated_by;comment:更新人"`
	DeletedAt gorm.DeletedAt `json:"-" gorm:"column:deleted_at;index;comment:删除时间"`
	DeletedBy uint           `json:"deleted_by" gorm:"column:deleted_by;comment:删除人"`
}
